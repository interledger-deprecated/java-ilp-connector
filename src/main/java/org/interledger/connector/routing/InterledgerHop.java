...
public interface InterledgerHop {
    ...
    /**
     * The ILP address of the account to credit funds to as part of the "next" local-ledger transfer
     * (the source-account will always be the account of the connector at the destination ledger).
     */
    ...
    /**
     * Determines if this hop is servicable by a ledger that is locally-connected to the Connector
     * wanting to know about a next-hop. If a hop is "final", it means that this connector is
     * delivering this payment (as opposed to forwarding it). *
     *
     * @return {@code true} if this hop is the final hop; {@code false} if this hop is an
     *     intermediate hop.
     *
