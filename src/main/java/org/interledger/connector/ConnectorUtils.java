...
public class ConnectorUtils {
   ...
   *
   * This method can be used to generate a deterministic identifier for the "next" transfer that a
   * Connector might make, so that the connector doesn't send duplicate outgoing transfers if it
   * receives duplicate notifications. In the case of a Connector's next-hop transfer identifier,
   ...
   *
   * @param secret       A {@link String} containing secret information known only to the creator of
   *                     this transfer id.
